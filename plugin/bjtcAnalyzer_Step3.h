...
void bjtcAnalyzer_Step3::produce_djtc(){
		...
		matrixTH1Ptr* m2j_data = new matrixTH1Ptr("sig_mix_seagull_corrected_inclJet_Data_pTweighted_noCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2y_data = new matrixTH1Ptr("sig_mix_seagull_corrected_inclJet_Data_noCorr_*_*", npt, ncent);
		m2y_data->autoLoad(fdata);
		m2j_data->autoLoad(fdata);
		std::cout<<"here"<<std::endl;
		matrixTH1Ptr* m2j_trk = new matrixTH1Ptr("dijtc_jetShape_trkCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2y_trk = new matrixTH1Ptr("dijtc_yield_trkCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2j_jff = new matrixTH1Ptr("dijtc_jetShape_jff_*_*", npt, ncent);
		matrixTH1Ptr* m2y_jff = new matrixTH1Ptr("dijtc_yield_jff_*_*", npt, ncent);
...
void bjtcAnalyzer_Step3::get_bjtc_correction(){
		gQA->pad_map = ps->getPara<mapper_func>("pad_map");
		matrixTH1Ptr* m2y_tt_rg = new matrixTH1Ptr("dr_mix_seagull_corrected_taggedTrueBJet_RecoJet_GenTrack_noCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2y_tb_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_trueBJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
		...
		matrixTH1Ptr* m2j_tt_rg = new matrixTH1Ptr("dr_mix_seagull_corrected_taggedTrueBJet_RecoJet_GenTrack_pTweighted_noCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2j_tb_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_trueBJet_GenJet_GenTrack_pTweighted_noCorr_*_*", npt, ncent);
		...
		matrixTH1Ptr* m2y_tt_rr = new matrixTH1Ptr("dr_mix_seagull_corrected_taggedTrueBJet_RecoJet_RecoTrack_noCorr_*_*", npt, ncent);
		...
		matrixTH1Ptr* m2y_tt_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_taggedTrueBJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
...
//		auto m2y_trk_au = (*m2y_tt_gr)%(*m2y_tt_gg);
		...
		matrixTH1Ptr* m2j_tt_rr = new matrixTH1Ptr("dr_mix_seagull_corrected_taggedTrueBJet_RecoJet_RecoTrack_pTweighted_noCorr_*_*", npt, ncent);
		...
		matrixTH1Ptr* m2y_co_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_contJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2j_co_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_contJet_GenJet_GenTrack_pTweighted_noCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2y_in_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_inclJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
		matrixTH1Ptr* m2j_in_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_inclJet_GenJet_GenTrack_pTweighted_noCorr_*_*", npt, ncent);
		m2y_co_gg->autoLoad(fdMC_gg);
		m2j_co_gg->autoLoad(fdMC_gg);
		m2y_in_gg->autoLoad(fdMC_gg);
		m2j_in_gg->autoLoad(fdMC_gg);

		matrixTH1Ptr* m2j_tg_gg = new matrixTH1Ptr("dr_mix_seagull_corrected_taggedBJet_GenJet_GenTrack_pTweighted_noCorr_*_*", npt, ncent);
...
void bjtcAnalyzer_Step3::produce_bjtc(){
		...
		auto m2j_trk = new jtcTH1Player("bjtc_jetShape_trkCorr"+sform, npt, ncent);
		auto m2y_trk = new jtcTH1Player("bjtc_yield_trkCorr"+sform, npt, ncent);
		auto m2j_jff = new jtcTH1Player("bjtc_jetShape_jff"+sform, npt, ncent);
		auto m2y_jff = new jtcTH1Player("bjtc_yield_jff"+sform, npt, ncent);
		auto m2j_cont = new jtcTH1Player("bjtc_jetShape_contCorr"+sform, npt, ncent);
		auto m2y_cont = new jtcTH1Player("bjtc_yield_contCorr"+sform, npt, ncent);
		...
		auto m2j_in_data = new jtcTH1Player("sig_mix_seagull_corrected_inclJet_Data_pTweighted_noCorr"+sform, npt, ncent);
		auto m2y_in_data = new jtcTH1Player("sig_mix_seagull_corrected_inclJet_Data_noCorr"+sform, npt, ncent);
		auto m2j_tg_data = new jtcTH1Player("sig_mix_seagull_corrected_taggedBJet_Data_pTweighted_noCorr"+sform, npt, ncent);
		auto m2y_tg_data = new jtcTH1Player("sig_mix_seagull_corrected_taggedBJet_Data_noCorr"+sform, npt, ncent);
...
//		std::cout<<folder+"bjtc_correction.root"<<std::endl;
		...
		gAnaIO.saveCanvas(gQA->jtc_check001( *m2j_step3), "bjtc_bkgcheck001");
...
void bjtcAnalyzer_Step3::ending_plots(){
		...
		TString savefname = "AN17337Result_new.root";
		TString folder_b = ps->getPara<TString>("step3output_folder_b");
		TString folder_in = ps->getPara<TString>("step3output_folder_in");
		auto fd = TFile::Open(folder_in+"inclJet_data_final.root");
		auto fb = TFile::Open(folder_b+"bjtc_data_final.root");
		...
		auto h2data_d= new jtcTH1Player("dijtc_jetShape_step3_*_*", npt, ncent);
		auto data_di = new jtcTH1Player("dr_signal_dijtc_jetShape_step3_*_*");
		auto data_b = new jtcTH1Player("dr_signal_bjtc_jetShape_step3_*_*");
		auto h2data_b= new jtcTH1Player("signal_bjtc_jetShape_step3_*_*", npt, ncent);
		auto data_di_err= new jtcTH1Player("dr_dijtc_jetShape_systError_*_*", npt, ncent);
		auto data_b_err= new jtcTH1Player("dr_bjtc_jetShape_systError_*_*", npt, ncent);
		...
		auto mc_di_sig= new jtcTH1Player("signal_inclJet_GenJet_GenTrack_pTweighted_noCorr_*_*", npt, ncent);
		auto mc_b_sig= new jtcTH1Player("signal_trueBJet_GenJet_GenTrack_pTweighted_noCorr_*_*", npt, ncent);
		...
		auto m2_mc_b0 = new jtcTH1Player("signal_trueBJet_GenJet_GenTrack_pTweighted_noCorr_*_*");
		auto dr_mc_b0 = new jtcTH1Player("dr_signal_trueBJet_GenJet_GenTrack_pTweighted_noCorr_*_*");
		...
		auto ratio_mc0_in_all = (*dr_data_d_all)/(*dr_mc_d_all);
		auto ratio_mc0_in_all_err = (*dr_data_d_err)/(*dr_mc_d_err);
		auto ratio_mc0_b_all = (*dr_data_b_all)/(*dr_mc0_b_all);
		auto ratio_mc0_b_all_err = (*dr_data_b_err)/(*dr_mc0_b_err);

		gQA->bookLegend(0.55, 0.55, 0.9, 0.83);
		gQA->addm2TH1(ratio_mc0_in_all);
		gQA->addm2TH1Error(ratio_mc0_in_all_err);
		gQA->addm2TH1(ratio_mc0_b_all);
		gQA->addm2TH1Error(ratio_mc0_b_all_err);
		gQA->addLegendEntry("Inclusive", 0);
		gQA->addLegendEntry("b-jet", 1);
		/*
...
//		gQA->addm2TH1(ratio_mc_all_err, "ce5");
		...
		*/
		...
		gAnaIO.saveCanvas(gQA->overlay(), "integratedJSRatioXX");
...
/*
		...
		*/
		...
		auto ym2_mc_d= new jtcTH1Player("signal_inclJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
		auto ym2_mc_b= new jtcTH1Player("signal_trueBJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
		...
		auto ym2_mc0_d= new jtcTH1Player("signal_inclJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
		auto ym2_mc0_b= new jtcTH1Player("signal_trueBJet_GenJet_GenTrack_noCorr_*_*", npt, ncent);
		...
		auto ydata_d = new jtcTH1Player("dr_signal_dijtc_yield_step3_*_*");
		auto ydata_d_err = new jtcTH1Player("dr_dijtc_yield_systError_*_*");
		auto ydata_b = new jtcTH1Player("dr_signal_bjtc_yield_step3_*_*");
		auto ydata_b_err = new jtcTH1Player("dr_bjtc_yield_systError_*_*");
		ydata_d->autoLoad(fd);
		...
		auto fw = TFile::Open(savefname, "recreate");
		data_di->write();
		data_b->write();
		data_b_err->write();
		data_di_err->write();
...
void bjtcAnalyzer_Step3::produce_pythia(){
		auto mc_di_sig= new jtcTH1Player("signal_inclJet_GenJet_GenTrack_noCorr_*_*", npt-1, ncent);
		auto mc_b_sig= new jtcTH1Player("signal_trueBJet_GenJet_GenTrack_noCorr_*_*", npt-1, ncent);
		mc_di_sig->autoLoad(fdMC_gg);
		mc_b_sig->autoLoad(fbMC_gg);
		auto mc_di_prox = mc_di_sig->getBkgError();
		auto mc_b_prox = mc_b_sig->getBkgError();
		auto dr_mc_di = mc_di_sig->drIntegral("dr_dijtc_yield_gg",ndrbin, drbins);
		auto dr_mc_b = mc_b_sig->drIntegral("dr_bjtc_yield_gg", ndrbin, drbins);
		auto mc_di_err= (jtcTH1Player*)dr_mc_di->clone("dr_dijtc_yield_systError");
		auto mc_b_err = (jtcTH1Player*)dr_mc_b->clone("dr_bjtc_yield_systError");
		mc_di_err->setDrError(mc_di_sig);
		mc_b_err->setDrError(mc_b_sig);

		float binwidth[5] = {1, 1, 1, 4, 4};
		for(int i=0; i<5; ++i){
				dr_mc_di->at(i,0)->Scale(1.0/binwidth[i]);
				dr_mc_b ->at(i,0)->Scale(1.0/binwidth[i]);
				mc_di_err->at(i,0)->Scale(1.0/binwidth[i]);
				mc_b_err->at(i,0)->Scale(1.0/binwidth[i]);
		}
		auto mc_d_all = dr_mc_di-> contractX("dr_dijtc_yield_all");
		auto mc_b_all = dr_mc_b-> contractX("dr_bjtc_yield_all");
		auto mc_d_all_err = mc_di_err->contractX("dr_dijtc_yield_all_systError");
		auto mc_b_all_err = mc_b_err->contractX("dr_bjtc_yield_all_systError");
		auto wf = TFile::Open("PYTHIA6_reference.root", "recreate");
		dr_mc_di->write();
		dr_mc_b->write();
		mc_di_err->write();
		mc_b_err ->write();
		mc_d_all->at(0,0)->Write();
		mc_b_all->at(0,0)->Write();
		mc_d_all_err->at(0,0)->Write();
		mc_b_all_err->at(0,0)->Write();
		wf->Close();
}
